...
public class PositionCalculatorException extends Exception {
    ...
    protected PositionCalculatorException(TrilateralizationExceptionError error) {
    ...
    public enum TrilateralizationExceptionError {
        ...
        TrilateralizationExceptionError(final String value) {
            this.value = value;
        }
